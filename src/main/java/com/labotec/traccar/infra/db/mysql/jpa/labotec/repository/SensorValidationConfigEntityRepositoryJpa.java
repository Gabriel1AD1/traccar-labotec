...
public interface SensorValidationConfigEntityRepositoryJpa extends JpaRepository<SensorValidationConfigEntity, Long> {
    ...
    @Query("SELECT s.nameSensor AS nameSensor, s.dataType as dataType, s.operator AS operator, s.value AS value ,s.typeValidation as typeValidation ,s.messageAlert as messageAlert " +
